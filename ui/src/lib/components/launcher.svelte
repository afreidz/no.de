...
<style lang="scss">
  ...
  main {
    ...
    color: map.get($theme, 'colors', 'white', '0');
  }

  .brain {
    width: $width;
    border-radius: map.get($theme, 'radius');
    background: map.get($theme, 'colors', 'black', '2');
    border: 1px solid map.get($theme, 'colors', 'gray', '0');
  }
  
  label {
    display: flex;
    border-bottom: 1px solid map.get($theme, 'colors', 'gray', '0');
  ...
  ul {
    ...
    li {
      ...
      &.active {
        background: map.get($theme, 'colors', 'black', '4');
      }
    }
  }
